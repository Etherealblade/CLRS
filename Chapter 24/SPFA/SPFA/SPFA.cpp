...
Keywords:  shortest path faster algorithm

ULR: https://www.geeksforgeeks.org/shortest-path-faster-algorithm/
*/
...
{
	graph[frm].emplace_back(to, weight);
}
...
// Func to compute the SPF alg
void shortestPathFaster(int S)
{
